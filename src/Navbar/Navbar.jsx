  ...
  return (
    <div className='nav_container'>
        ...
        <div className='nav_list'>
            ...
            <div>
                <a href="https://github.com/ayushsingh0607" target='_blank' style={{color:'inherit'}}><AiFillGithub size="3rem"/></a>
                <a href="https://www.linkedin.com/in/ayush-raj-9b4255209/" target='_blank' style={{color:'inherit'}}><AiFillLinkedin size="3rem"/></a>
            </div>
        </div>
    </div>
  )
